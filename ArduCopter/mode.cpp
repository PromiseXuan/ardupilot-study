...
void Copter::notify_flight_mode() {
    AP_Notify::flags.autopilot_mode = flightmode->is_autopilot();//autopilotmode
    AP_Notify::flags.flight_mode = control_mode;//flight mode
    notify.set_flight_mode_str(flightmode->name4());//设置飞行模式的字符串名称
}
